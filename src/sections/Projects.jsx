...
import { ExternalLink, Github, Shield, MapPin, Activity, Workflow } from 'lucide-react';

const projectsData = [
  {
    id: 1,
    title: "Cybereum",
    description: "A 2024–2025 Capstone Thesis Project. A gamified educational platform designed to teach K-12 students essential cybersecurity concepts through interactive lessons, badges, and leaderboards.",
    tech: ["React", "Supabase", "Gamification", "Educational Tech"],
    icon: Shield,
    githubUrl: "#",
    liveUrl: "#",
  },
  {
    id: 2,
    title: "DLSUD - GO",
    description: "A campus navigation mobile app for De La Salle University–Dasmariñas. Helps students, staff, visitors, and applicants navigate facilities, find information, and stay updated on campus events.",
  ...
  },
  {
    ...
    description: "A full-stack fitness and dietary tracking web app. Users can log daily walks, monitor caloric intake, track macros, and visualize weekly progress through clean analytics dashboards.",
  ...
  },
  {
    ...
    description: "An intelligent e-commerce automation workflow built with n8n. Streamlines shop operations, handles multi-step data routing, and reduces manual overhead across business pipelines.",
    tech: ["n8n", "Automation", "Webhooks", "E-commerce"],
    icon: Workflow,
    githubUrl: "#",
    liveUrl: "#",
  },
